...
import {Colon_String, Empty_String, Hyphen_String, Space_String, Underscore_String} from "./ValueUtil";
...
export function standardFormat({
                                   ...
                                   separatorDate = Hyphen_String,
                                   separatorTime = Colon_String
...
export function datetimeForFilename(date: Date): string {
    return standardFormat({
        date,
        separator: Underscore_String,
        separatorDate: Hyphen_String,
        separatorTime: Hyphen_String
    }) + Underscore_String + date.getMilliseconds()
}
